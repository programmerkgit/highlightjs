...
(function (factory) {
  ...
  function highlight(languageName, code, ignore_illegals, continuation) {
    ...
    /* return regexp as letter implies */
    ...
    /* leaveOpen and noPrefix Will Be Options
     * create <span class="clasPrefix className"> insideSpan </span>
     * if no class name, return insideSpan
     * span is used to add class name.
     *
     * */
